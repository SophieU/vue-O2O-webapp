...
var TouchSlide = function(a){
	...
	for ( var i =0; i<tempSize; i++ ){
		var cssStr = ''
		if(opts.full){
			cssStr = "display:table-cell;vertical-align:top;width:"+slideW+"px;height:"+screenHeight+"px";
        }else{
			cssStr = "display:table-cell;vertical-align:top;width:"+slideW+"px";
        }
		conBox.children[i].style.cssText= cssStr;
	}
